    ...
    try {
        ...
        if (data.success) {
            ...
            container.innerHTML = data.notificaciones.map(n => `
                <div class="notification-card ${!n.leido ? 'no-leida' : ''}" data-id="${n.id}" data-tipo="${n.tipo}" data-emisor-id="${n.emisor_id}">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <!-- Botones SOLO para solicitudes de amistad NO leídas -->
                            ...
                            <!-- Para otros tipos de notificaciones ya leídas, mostrar solo el mensaje -->
                            ${n.tipo !== 'solicitud_amistad' || n.leido ? `
                            <div class="mt-1">
                                <small class="text-muted">${n.tipo === 'like' ? '❤️' : n.tipo === 'comentario' ? '💬' : '📢'}</small>
                            </div>
                            ` : ''}
                        </div>
